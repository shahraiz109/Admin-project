...
const Sidbar = () => {
  return (
    <div className='bg-[#4E73DF] h-screen px-[15px]'>
      <div className='px-[15px] py-[30px] flex items-center justify-center border-b-[1px] border-[#EDEDED]/[0.3]'>
        <h1 className='text-white text-[15px] leading-[24px] font-extrabold cursor-pointer'>Admin Panel</h1>
      </div>
 ...
 <FaBolt color='white'/>
 <p className='text-[12px] leading-[18px] font-normal text-white/[0.4] text-center'>Lorem admin website, developed by Mehar Ali from lahore Pakistan</p>
